...
namespace ODataPlatform.Account
{
    public partial class UserRoleManagement : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.DropDownListRoles.SelectedValue = RoleManager.SystemRole_Operator;
                this.BindData(RoleManager.SystemRole_Operator);
            }
        }
        ...
        protected void GridViewUsersInRole_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            //(new RoleManager()).SetUserRole(userName, selectedRoleName);

            Provider.RoleManager().SetUserRole(userName, selectedRoleName);
