...
namespace DataIntegrator.Helpers.Tracing
{
    class TracingHelper
    {
        public static string DefaultTraceSourceName = "DataIntegratorTraceSource";

        public static void Trace(object[] data, string traceSourceName) 
        {
            try
            {
                string sourceName = !String.IsNullOrEmpty(traceSourceName) ? traceSourceName : TracingHelper.DefaultTraceSourceName; 
