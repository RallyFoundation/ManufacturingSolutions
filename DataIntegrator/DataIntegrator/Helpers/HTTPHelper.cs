...
namespace DataIntegrator.Helpers.HTTP
{
    class HTTPHelper
    {
        ...
        public HTTPHelper() 
        {
            if (!HTTPHelper.IsServicePointManagerParamsSet)
            {
                System.Net.ServicePointManager.ServerCertificateValidationCallback += new System.Net.Security.RemoteCertificateValidationCallback(HTTPHelper.remoteCertificateValidationCallback);
                System.Net.ServicePointManager.Expect100Continue = false;

                HTTPHelper.IsServicePointManagerParamsSet = true;
            }
        }

        public HTTPHelper(bool enableTracing, string traceSourceName) 
        {
        ...
        public virtual string Post(string uri, string data, Authentication authentication, Dictionary<string, string> headers)
        {
           return this.createSyncRequest(uri, data, "POST", authentication, headers);
        }

        public virtual string Get(string uri, Authentication authentication, Dictionary<string, string> headers)
        {
            return this.createSyncRequest(uri, null, "GET", authentication, headers);
        }

        public virtual async Task PostAsync(string uri, byte[] data, Authentication authentication, Dictionary<string, string> headers)
        {
        ...
        public virtual async Task GetAsync(string uri, Authentication authentication, Dictionary<string, string> headers)
        {
