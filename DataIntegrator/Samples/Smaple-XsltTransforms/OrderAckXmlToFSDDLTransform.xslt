...
>
  ...
  <!--<xsl:output method="xml" indent="yes" omit-xml-declaration="no" />-->
    ...
    <xsl:template match="@* | node()">
      ...
      <Directory xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" Name="OrderAcknowledgements" Type="OrderAcknowledgement" Title="Order Acknowledgements">
        <Description>Order Acknowledgements</Description>
        <Directories>
          <Directory>
