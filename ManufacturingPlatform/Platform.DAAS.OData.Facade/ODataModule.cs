...
{
    public class ODataModule : IHttpModule
    {
        public void Dispose()
        {
        ...
        private void Context_BeginRequest(object sender, EventArgs e)
        {
            ...
            if (requestPath.ToLower().StartsWith( "/" + Global.ODATA_RESOURCE_ROUTE_PREFIX.ToLower()))
            {
                ...
                if (context.Request.Headers[Global.HTTP_HEADER_NAME_SERVICE_ID] != null)
                {
                    ...
                    if (context.Request.Headers[HttpRequestHeader.Authorization.ToString()] != null)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                //context.Request.Headers.Add("DAAS-DB-CONNECTION", Platform.DAAS.OData.ServiceManager.ModuleConfiguration.ServiceDBConnectionStrings[serviceID]);
